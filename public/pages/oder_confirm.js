...
export default class {
    ...
    makeUserCheckOutForm(u_id, total_amount) {
    ...
    makeGuestCheckOutForm(total_amount) {
...
document.addEventListener('click',function(e){  
    ...
    if(e.target && e.target.className == 'user_checkout_submit_button') {
        ...
        const send_data = {amount : user_total_amount};
        ...
        fetch('/user_checkout_submit', data)
